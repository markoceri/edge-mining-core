...
global _cli_adapter_service, _cli_optimization_service, _cli_miner_action_service, \
        _cli_configuration_service, _cli_logger
...
def requires_services(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if not all([_cli_adapter_service, _cli_optimization_service, _cli_miner_action_service,
                    _cli_configuration_service, _cli_logger]):
            click.echo(click.style("Error: Services not initialized.", fg="red"), err=True)
