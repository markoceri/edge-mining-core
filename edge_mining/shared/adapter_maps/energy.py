...
ENERGY_SOURCE_TYPE_FORECAST_PROVIDER_CONFIG_MAP: Dict[EnergySourceType, Optional[List[EnergyMonitorConfig]]] = {
    EnergySourceType.SOLAR: [
        ForecastProviderDummySolarConfig,
        ForecastProviderHomeAssistantConfig,
    ],
...
ENERGY_SOURCE_TYPE_FORECAST_PROVIDER_CLASS_MAP: Dict[EnergySourceType, Optional[List[EnergyMonitorPort]]] = {
    EnergySourceType.SOLAR: [
...
ENERGY_SOURCE_TYPE_ENERGY_MONITOR_CLASS_MAP: Dict[EnergySourceType, Optional[List[EnergyMonitorPort]]] = {
    EnergySourceType.SOLAR: [
...
ENERGY_MONITOR_CONFIG_TYPE_MAP: Dict[EnergyMonitorAdapter, Optional[EnergyMonitorConfig]] = {
